...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_displayHero_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/displayHero.js */ \"./src/modules/displayHero.js\");\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n// import _ from 'lodash';\n\n\ndocument.addEventListener('DOMContentLoaded', (0,_modules_displayHero_js__WEBPACK_IMPORTED_MODULE_0__.displayHero)(0, 'image'));\ndocument.addEventListener('DOMContentLoaded', (0,_modules_displayHero_js__WEBPACK_IMPORTED_MODULE_0__.Displaymovies)(20));\n\n//# sourceURL=webpack://webpack-boilerplate/./src/index.js?");

/***/ }),

/***/ "./src/modules/displayHero.js":
/*!************************************!*\
  !*** ./src/modules/displayHero.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Displaymovies\": () => (/* binding */ Displaymovies),\n/* harmony export */   \"displayHero\": () => (/* binding */ displayHero)\n/* harmony export */ });\nvar displayHero = function displayHero(number, section) {\n  fetch('https://ghibliapi.herokuapp.com/films').then(function (response) {\n    return response.json();\n  }).then(function (data) {\n    var imageContainer = document.querySelector('.hero-image');\n    imageContainer.innerHTML += \"<img src=\\\"\".concat(data[number][section], \"\\\" />\");\n  });\n};\nvar Displaymovies = function Displaymovies(number) {\n  fetch('https://ghibliapi.herokuapp.com/films').then(function (response) {\n    return response.json();\n  }).then(function (data) {\n    for (var i = 0; i < number; i += 1) {\n      var hour = Math.floor(data[i].running_time / 60);\n      var minutes = data[i].running_time % 60;\n      var listContainer = document.querySelector('.list-container');\n      listContainer.innerHTML += \"<div class=\\\"movie-container\\\">\\n          <img class=\\\"movie-image\\\" src=\\\"\".concat(data[i].image, \"\\\" alt=\\\"\").concat(data[i].title, \"\\\">\\n            <div class=\\\"movie-info\\\">\\n              <h3>\").concat(data[i].title, \"</h3>\\n              <p>\").concat(data[i].release_date, \"</p>\\n              <p>\").concat(hour, \"h \").concat(minutes, \" min</p>\\n            </div>\\n            <div class=\\\"movie-buttons\\\">\\n              <button class=\\\"like-button\\\">Like</button>\\n              <button class=\\\"comment-button\\\">Comment</button>\\n            </div>\\n          </div>\");\n    }\n  });\n};\n\n//# sourceURL=webpack://webpack-boilerplate/./src/modules/displayHero.js?");
